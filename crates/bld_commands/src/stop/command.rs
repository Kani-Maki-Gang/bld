...
pub struct StopCommand {
    #[arg(short = 'i', long = "id", required = true, help = "The id of a pipeline running on a server")]
    pipeline_id: String,

    #[arg(short = 's', long = "server", help = "The name of the server that the pipeline is running")]
