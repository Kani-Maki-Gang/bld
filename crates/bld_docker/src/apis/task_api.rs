...
pub async fn task_inspect(
    ...
    id: &str,
) -> Result<crate::models::Task, Error<TaskInspectError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TaskInspectError> =
...
pub async fn task_list(
    configuration: &configuration::Configuration,
    filters: Option<&str>,
) -> Result<Vec<crate::models::Task>, Error<TaskListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TaskListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
            entity: local_var_entity,
...
pub async fn task_logs(
    ...
    tail: Option<&str>,
) -> Result<std::path::PathBuf, Error<TaskLogsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TaskLogsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
            entity: local_var_entity,
