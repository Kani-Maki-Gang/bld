...
pub struct GenericResourcesInner {
    ...
    pub named_resource_spec: Option<Box<crate::models::GenericResourcesInnerNamedResourceSpec>>,
    #[serde(
        rename = "DiscreteResourceSpec",
        skip_serializing_if = "Option::is_none"
    )]
    pub discrete_resource_spec:
        Option<Box<crate::models::GenericResourcesInnerDiscreteResourceSpec>>,
}
